...
namespace BlueSkyTravel.Migrations.UserDb
{
    ...
    [Migration("20200403150818_FirstMigration")]
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalDate = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            DepartureDate = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            Fare = 426.0,
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.ForFun", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EventTime = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            Fare = 100.0,
                            IsApproved = false,
                            ItineraryId = 1,
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckIn = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            CheckOut = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            ItineraryId = 1,
                            Name = "Holiday Inn",
                            NightlyRate = 150.0
                        });
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TravelDateFinish = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            TravelDateStart = new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
