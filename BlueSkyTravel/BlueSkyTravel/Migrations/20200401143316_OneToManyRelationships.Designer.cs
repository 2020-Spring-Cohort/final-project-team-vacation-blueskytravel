...
namespace BlueSkyTravel.Migrations
{
    ...
    [Migration("20200401143316_OneToManyRelationships")]
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalDate = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            DepartureDate = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            Fare = 426.0,
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.ForFun", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EventTime = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            Fare = 100.0,
                            IsApproved = false,
                            ItineraryId = 1,
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckIn = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            CheckOut = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            ItineraryId = 1,
                            NightlyRate = 150.0
                        });
                });
            ...
            modelBuilder.Entity("BlueSkyTravel.Models.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TravelDateFinish = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            TravelDateStart = new DateTime(2020, 4, 1, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
